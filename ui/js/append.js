    ...
    $(".container").append(
        ...
        <div class="value-type-option" id="value_type_option_${idString}" style="overflow-y: auto;"> 
            ...
            <div class="template-value-type">
                ...
                <span onclick="getTemplateValueType(this)" >Datetime</span>
                ...
                <span onclick="getTemplateValueType(this)" >Work</span>
            ...
            <div class="option-zone">
                ...
                <div class="type-option" aria-label="Properties"  onclick="getAndAppendValueType(this,'${idString}')" >
                    <h4>Boolean</h4>
                    <p>True or False</p> 
                </div>
                <div class="type-option" aria-label="Information" onclick="getAndAppendValueType(this,'${idString}')" >
                ...
                <div class="type-option" aria-label="Bank" onclick="getAndAppendValueType(this,'${idString}')" >
                    <h4>Credit Card</h4>
                ...
                <div class="type-option" aria-label="Office" onclick="getAndAppendValueType(this,'${idString}')" >
                    <h4>Company Name</h4>
                    <p>Fake company name</p> 
                </div>
                <div class="type-option" aria-label="Work" onclick="getAndAppendValueType(this,'${idString}')" >
                ...
                <div class="type-option" aria-label="Datetime" onclick="getAndAppendValueType(this,'${idString}')" >
                    <h4>Date</h4>
                ...
                <div class="type-option" aria-label="Teachnology" onclick="getAndAppendValueType(this,'${idString}')" >
                    <h4>IPV4</h4>
